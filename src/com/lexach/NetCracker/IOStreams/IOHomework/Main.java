package com.lexach.NetCracker.IOStreams.IOHomework;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        File txtFile = new File("src/com/lexach/NetCracker/IOStreams/IOHomework/enc.txt");
        File jpgFile = new File("src/com/lexach/NetCracker/IOStreams/IOHomework/pic.jpg");
