...
public class Main {
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        // Ограничения, которые навешиваются.

        // Написать программу, на вход которо подается класс, а прога пробегается по иерархии наверх
        // и красиво выводит названия методов.
